...
[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
public delegate bool GDExtensionInitializationFunction(IntPtr p_get_proc_address, IntPtr p_library,
    ref GDExtensionInitialization r_initialization);
...
[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
public delegate void GDExtensionInterfaceObjectMethodBindPtrcall(IntPtr p_method_bind, IntPtr p_instance, IntPtr p_args,
    IntPtr p_ret);

[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
public delegate void GDExtensionInterfaceStringNameNewWithLatin1Chars(IntPtr r_dest, IntPtr p_contents,
    byte p_is_static);
...
{
    const string LIBGODOT_LIBRARY_NAME = "libgodot.linuxbsd.editor.dev.x86_64.shared_library";
    ...
    private static GDExtensionInitializationCallback initDelegate =
        new GDExtensionInitializationCallback(InitializeCallback);

    private static GDExtensionInitializationCallback deinitDelegate =
        new GDExtensionInitializationCallback(DeinitializeCallback);

    public static bool InitCallback(IntPtr p_get_proc_address, IntPtr p_library,
        ref GDExtensionInitialization r_initialization)
    {
        ...
        var getProcAddress =
            Marshal.GetDelegateForFunctionPointer<GDExtensionInterfaceGetProcAddress>(p_get_proc_address);
        ...
        if (objectGetInstanceIdPtr != IntPtr.Zero) {
            objectGetInstanceId =
                Marshal.GetDelegateForFunctionPointer<GDExtensionInterfaceObjectGetInstanceId>(objectGetInstanceIdPtr);
        }
        ...
        if (classdbGetMethodBindPtr != IntPtr.Zero) {
            classdbGetMethodBind =
                Marshal.GetDelegateForFunctionPointer<GDExtensionInterfaceClassdbGetMethodBind>(
                    classdbGetMethodBindPtr);
        }
        ...
        if (objectMethodBindPtrcallPtr != IntPtr.Zero) {
            objectMethodBindPtrcall =
                Marshal.GetDelegateForFunctionPointer<GDExtensionInterfaceObjectMethodBindPtrcall>(
                    objectMethodBindPtrcallPtr);
        }
        ...
        if (stringNameNewWithLatin1CharsPtr != IntPtr.Zero) {
            stringNameNewWithLatin1Chars =
                Marshal.GetDelegateForFunctionPointer<GDExtensionInterfaceStringNameNewWithLatin1Chars>(
                    stringNameNewWithLatin1CharsPtr);
        }
    ...
    public static GodotInstance? GetGodotInstanceFromPtr(IntPtr godotInstancePtr)
    {
        ...
        GodotObject? obj = GodotObject.InstanceFromId(instanceId);
