...
internal struct NarrowPhaseCallbacks : INarrowPhaseCallbacks
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    bool INarrowPhaseCallbacks.ConfigureContactManifold<TManifold>(int workerIndex, CollidablePair pair, ref TManifold manifold, out PairMaterialProperties pairMaterial)
    {
